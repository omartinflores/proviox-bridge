...
class HelloMessage extends JsonMessage {
    ...
    serialize(): ArrayBuffer {
        this.json = {
            ...
            "HostName": this.hostname || "Snapweb client",
            "Version": this.version || "0.0.0",
            "ClientName": this.clientName || "Snapweb",
            "OS": this.os || "unknown",
            "Arch": this.arch || "web",
            "Instance": this.instance || 1,
            "ID": this.uniqueId || "",
            "SnapStreamProtocolVersion": this.snapStreamProtocolVersion || 2
        };
    ...
    mac: string = "";
    hostname: string = "";
    version: string = import.meta.env.VITE_APP_VERSION || "0.0.0";
    clientName: string = import.meta.env.VITE_APP_NAME || "Snapweb";
